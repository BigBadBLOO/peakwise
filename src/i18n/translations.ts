  ...
  en: {
    ...
    workout: {
      ...
      ai_module: {
        ...
        download_title: 'Personalized AI recommendations',
        download_sub: 'Download the on-device AI model to get daily coaching based on your readiness score. Runs fully offline after download.',
        download_btn: (size: string) => `Download · ${size}`,
        downloading: 'Downloading AI model...',
        loading_model: 'Loading model into memory...',
        inferring: 'Analyzing your data...',
  ...
  ru: {
    ...
    workout: {
      ...
      ai_module: {
        ...
        download_title: 'Персональные AI-рекомендации',
        download_sub: 'Загрузите AI-модуль для ежедневных советов по интенсивности. Работает полностью офлайн после загрузки.',
        download_btn: (size: string) => `Загрузить · ${size}`,
        downloading: 'Загружаем AI-модуль...',
        loading_model: 'Загружаем модель в память...',
        inferring: 'Анализируем данные...',

...
export const translations = {
  en: {
    ...
    home: {
      ...
      readiness: 'Readiness',
      readiness_states: {
        ready: { title: "You're fully recovered.",   sub: 'Perfect day for an intense workout. Push your big lifts today.' },
        good:  { title: 'Well recovered.',            sub: 'Good energy — solid workout today.' },
        tired: { title: 'Some fatigue detected.',     sub: 'Consider lighter intensity or an extra rest day.' },
        rest:  { title: 'High fatigue.',              sub: 'Rest or very light activity recommended today.' },
        none:  { title: 'Morning check-in pending.',  sub: 'Rate how you feel to see your readiness score.' },
      },
      todays_workout: "TODAY'S WORKOUT",
      ai_built: 'Built around your training history.',
      start_workout: 'Start workout',
      rest_day: 'Rest day',
      rest_day_sub: 'Recovery is part of training. Stay active, walk, stretch.',
      no_plan: 'No plan yet.',
      no_plan_sub: 'Open Training tab to generate your weekly program.',
      streak: 'Streak',
      sleep: 'Sleep',
      hrv: 'HRV',
  ...
  ru: {
    ...
    home: {
      ...
      readiness_states: {
        ready: { title: 'Вы полностью восстановились.',   sub: 'Отличный день для интенсивной тренировки. Жми на максимум.' },
        good:  { title: 'Хорошее восстановление.',        sub: 'Хорошая энергия — продуктивная тренировка.' },
        tired: { title: 'Есть признаки усталости.',        sub: 'Рассмотри снижение интенсивности или дополнительный отдых.' },
        rest:  { title: 'Высокая усталость.',              sub: 'Рекомендуется отдых или очень лёгкая активность.' },
        none:  { title: 'Утренний чек-ин не пройден.',    sub: 'Оцени самочувствие, чтобы увидеть свой показатель готовности.' },
      },
      todays_workout: 'ТРЕНИРОВКА СЕГОДНЯ',
      ai_built: 'Составлено на основе твоей истории тренировок.',
      start_workout: 'Начать тренировку',
      rest_day: 'День отдыха',
      rest_day_sub: 'Восстановление — часть тренировки. Прогуляйся, потянись.',
      no_plan: 'Программы пока нет.',
      no_plan_sub: 'Открой вкладку Тренировки, чтобы создать недельный план.',
      streak: 'Серия',
      sleep: 'Сон',
      hrv: 'ВРС',

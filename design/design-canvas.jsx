...
// DesignCanvas.jsx â Figma-ish design canvas wrapper
// Warm gray grid bg + Sections + Artboards + PostIt notes.
// Artboards are reorderable (grip-drag), deletable, labels/titles are
// inline-editable, and any artboard can be opened in a fullscreen focus
// overlay (â/â/Esc). State persists to a .design-canvas.state.json sidecar
// via the host bridge. No assets, no deps.
//
// Usage:
//   <DesignCanvas>
//     <DCSection id="onboarding" title="Onboarding" subtitle="First-run variants">
//       <DCArtboard id="a" label="A Â· Dusk" width={260} height={480}>â¦</DCArtboard>
//       <DCArtboard id="b" label="B Â· Minimal" width={260} height={480}>â¦</DCArtboard>
//     </DCSection>
//   </DesignCanvas>
